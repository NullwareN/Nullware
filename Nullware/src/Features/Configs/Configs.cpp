...
bool CConfigs::SaveConfig(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Save config failed", ALTERNATE_COLOR,
...
bool CConfigs::LoadConfig(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    if (auto tSub = tRead.get_child_optional("Binds")) {
      ...
      SDK::Output("Nullware", "Config binds not found", ALTERNATE_COLOR,
                  OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
    ...
    if (auto oSub = tRead.get_child_optional("Vars");
      ...
      SDK::Output("Nullware", "Config vars not found", ALTERNATE_COLOR,
                  OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
    ...
    if (auto tSub = tRead.get_child_optional("Groups")) {
      ...
      SDK::Output("Nullware", "Config groups not found", ALTERNATE_COLOR,
                  OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
    ...
    SDK::Output("Nullware", "Load config failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
    return false;
  }
...
bool CConfigs::SaveVisual(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Save visuals failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
    return false;
  }
  return true;
...
bool CConfigs::LoadVisual(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Load visuals failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
    return false;
  }
  return true;
...
void CConfigs::DeleteConfig(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Remove config failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
  }
}
...
void CConfigs::ResetConfig(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Reset config failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
  }
}
...
void CConfigs::DeleteVisual(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Remove visuals failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
  }
}
...
void CConfigs::ResetVisual(const std::string &sConfigName, bool bNotify) {
  try {
    ...
    SDK::Output("Nullware", "Reset visuals failed", ALTERNATE_COLOR,
                OUTPUT_CONSOLE | OUTPUT_MENU | OUTPUT_DEBUG);
  }
}
