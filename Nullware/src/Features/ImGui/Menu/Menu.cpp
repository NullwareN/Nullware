        ...
        if (FButton("Import from clipboard", FButtonEnum::None,
          ...
          if (!content.empty()) {
            ...
            if (content.substr(0, 4) == "http") {
              HINTERNET hInternet =
                  InternetOpenA("Nullware Client", INTERNET_OPEN_TYPE_DIRECT,
                                NULL, NULL, 0);
              if (hInternet) {
                HINTERNET hUrl =
            ...
            if (f.is_open()) {
              ...
              SDK::Output("Nullware", "Config loaded from clipboard / URL",
                          DEFAULT_COLOR,
                          OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU |
                              OUTPUT_DEBUG);
              sStaticName.clear();
          ...
          if (bLoad) {
            ...
            if (f.is_open()) {
              ...
              if (!bSuccess) {
                ...
                SDK::Output(
                    "Nullware", "Config copied to clipboard (Upload failed)",
                    DEFAULT_COLOR,
                    OUTPUT_CONSOLE | OUTPUT_TOAST | OUTPUT_MENU | OUTPUT_DEBUG);
              }
            }
