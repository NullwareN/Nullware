...
void CMisc::ChatSpam() {
  ...
  static const std::vector<std::string> vSpamLines = {
      "Nullware - github.com/Devtom968/Nullware.", "Get good, get Nullware.",
      "Oops, I dropped my Nullware, now I'm dominating you.",
      "Don't be mad, be glad you witnessed Nullware.",
      "You tried your best, but my Nullware was better."};
  ...
  case FNV1A::Hash32Const("player_death"): {
    ...
    if (iAttacker == I::EngineClient->GetLocalPlayer() &&
      ...
      if (I::EngineClient->GetPlayerInfo(iVictim, &pi)) {
        char szCmd[256];
        sprintf_s(szCmd, "say \"%s just got obliterated by Nullware!\"",
                  pi.name);
